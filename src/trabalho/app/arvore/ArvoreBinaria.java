  	...
  	public boolean remover(int v) {
    	...
    	if (atual.esq == null && atual.dir == null) {
      		if (atual == root )
      			...
      			(filho_esq) pai.esq = null; // se for filho a esquerda do pai
           	else 
           	pai.dir = null; // se for filho a direita do pai
    	}
    	else if (atual.dir == null) {
       		if 
       			(atual == root) root = atual.esq; // se raiz
       		else if 
       			(filho_esq) pai.esq = atual.esq; // se for filho a esquerda do pai
            else
       		...
       		if (atual == root)
       			...
       			(filho_esq) pai.esq = atual.dir; // se for filho a esquerda do pai
            else 
